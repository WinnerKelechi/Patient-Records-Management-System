...
header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/doc.php");
exit();
}
?>
<!DOCTYPE html>
        ...
        <div class="col-md-1">
            ...
            <div class="content">
               ...
               ?>
                ...
                <p style="color:blue;">Welcome <strong style="color:blue;">
                        <?php echo $_SESSION['Dname']; ?></strong></p>
                <p><a href="adminpanel2.php?logout='1'" style="color: red;"><input type="button" value="Logout"></a></p>
                <?php endif ?>
            </div>
